...
@"
        ...
        //Login
        static void Login<T>(List<T> data)
        {
            Console.WriteLine("enter your id:");
            int id = int.Parse(Console.ReadLine());
            Console.WriteLine("enter your password:");
            string password = Console.ReadLine();
            //if (data.Any(x => x.Id == id) && data.Any(e => e.Password == password))
            //{
        ...
        static void Manage()
        {
            ...
            switch (managerInput)
            {
                case 1:
                    ...
                    Person emp = new Person(empId, empName, empPassword);
        ...
        static void Emp()
        {
            Employee employee = new Employee(1,"Ahmed", "123", 50000);
            //Login(Manager.LoadData());
                ...
                case 1:
                    ...
                    if (double.TryParse(Console.ReadLine(), out double balance))
                    {
                        ...
                        if (int.TryParse(Console.ReadLine(), out int accountType))
                        {
                            ...
                            employee.AddClient(id,name, pass, balance, isDebit);
                        }
                        else
                        {
